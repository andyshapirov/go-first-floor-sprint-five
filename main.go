...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) / MInKm * r.Weight * r.Duration.Hours() * MinInHours
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesWeightMultiplier + math.Pow(w.meanSpeed()*KmHInMsec, 2)/w.Height*CmInM*CaloriesSpeedHeightMultiplier) * w.Weight * w.Duration.Hours() * MinInHours
}
...
func (s Swimming) distance() float64 {
	return s.meanSpeed() * s.Duration.Hours()
}
